...
const { crearPlanHandler, actualizarPlanHandler, eliminarPlanHandler, obtenerPlanesHandler, obtenerPlanPorIdHandler, obtenerPlanesPorEquipoHandler, obtenerMejorPlanPorEquipoHandler, obtenerPlanesPorUbicacionTecnicaHandler, obtenerMejorPlanPorUbicacionTecnicaHandler, actualizarPlanesMantenimientoEquipo, actualizarPlanesMantenimientoUbicacionTecnica, cambiarEstadoPlanHandler } = require("../handlers/planMantenimientoHandler");
...
router.delete("/:id", roleAuth(["all_access","update_planes"]), eliminarPlanHandler);
